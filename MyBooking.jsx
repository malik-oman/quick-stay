...
const MyBooking = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32' >
      <Title  title='My Booking' subTitle='Easily manage your past, current, and upcoming hotel reservation in one place. plan your tips seamlessly with just a few clicks' align='left'  />
