        ...
        <div className='flex items-center gap-1 mt-2' >
         ...
         <p className='ml-2' >200+ reviews</p>
          ...
          <div className='flex flex-col md:flex-row md:justify-between mt-10' >
            ...
            <div>
              <p className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500' >Guests will be allocated on the ground floor according to availability. You a comfortable Two bedroom apartment has a true city feeling. The price qoted is for two guest, at the guest slot please mark the number of guests to get the exact price for groups. The Guests will be allocated ground floor according to availability. You get comfortable two bedroom apartment that has true city feeling.</p>
            </div>

            <div className='flex flex-col items-start gap-4' >
                <div className='flex gap-4' >
                  <img src={room.hotel.owner.image} alt="Host"  className='h-4 w-14 md:h-18 md:w-18 rounded-full' />
                  <div>
