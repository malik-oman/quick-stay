...
const [inputs, setInputs] = useState({
  ...
  return (
    <form>
        <Title align='left' font= 'outfit' title= 'Add Room' subTitle='Fill in the details carefully and accurate room details, pricing, and amenities, to enhance the user booking expereince.'  />  
          ...
          {Object.keys(images).map((key)=>(
              <label htmlFor={`roomImage${key}`}  key={key}>
                <img className='max-h-13 cursor-pointer opacity-80'
                 ...
                 <input type="file" accept='imae/*' id={`roomImage${key}`} hidden 
